 ...
 *===========================================================================
 *
 *  $Workfile:   gnugStdDefs.h  $
 *
 *  $Archive:   T:/SmartDeck/archives/Flight_Display/Development/StdHeaders/gnugStdDefs.h-arc  $
 *
 *  $Revision:   2.0  $
 *
...
#ifndef __GNUGSTDDEFS_H__
#define __GNUGSTDDEFS_H__
