...
def ask_coefficient_of_drag():
    ...
    Cd = prompt('Coefficient of Drag [%s]', 0.77)
    return Cd
...
def prompt_scooter_mph_from_hp():
    ...
    rider_lbs = ask_lbs_mass('Rider and backpack weight in lbs', 150)
    Cd = ask_coefficient_of_drag()
    A = ask_sq_ft_area('Frontal area in square feet', 4)
    mph = ask_mph('Maximum Velocity', 40)
